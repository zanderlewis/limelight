...
import bootcamp2.ArmSegment;
import bootcamp2.Claw;
import bootcamp2.Drive;
import bootcamp2.Robot;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        ArmSegment baseSegment = new ArmSegment(SegmentType.BASE, "base", 100);
        ArmSegment middleSegment = new ArmSegment(SegmentType.FIXED, "middle", 80);
        ArmSegment endSegment = new ArmSegment(SegmentType.FIXED, "end", 60);
